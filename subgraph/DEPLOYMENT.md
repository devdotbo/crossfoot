...
| v0.0.5 (`subgraph.events.yaml` with both Midas ABIs on every Midas source, commit b3d9489) | QmPm4RhwubryZFgcrXmhEEAxB3eTkpKCevUjbA9vg3kGgh | https://api.studio.thegraph.com/query/115545/crossfoot/v0.0.5 | 2026-09-02 01:27 UTC | archived when v0.0.7 was deployed (05:04 UTC); was at chain head (25,887,058, no indexing errors) on 2026-09-02 about 03:30 UTC, the first synced version; it sat at its start block 17,676,541 until about 02:50 UTC, then synced at the event-only rate; the survey block 25,884,405 was already outside Studio's 1,000-block history window when it got there, so the fixture is recorded at the head of recording instead; the fix was confirmed on the local graph-node (blocks 24,798,500 to 24,800,800: the mGLOBAL feed is created with bound 100000000, one Upgrade, one BoundChange) |
| v0.0.6 (`subgraph.yaml` with the ABI fix, call handlers, commit b3d9489) | QmTbJmL7Pj8KmKEcnMnb8wqopgGYuMbKEPMYtxz3a7Ho4a | https://api.studio.thegraph.com/query/115545/crossfoot/v0.0.6 | 2026-09-02 02:55 UTC | pending; the trace scan makes this the slow one (about a day); does not carry extension E3 |
| v0.0.7 (`subgraph.events.yaml`, event-only, extension E3: 101 sources, 95 feeds, commit c72461c) | QmeTCucCXDhT27pMMExg2EtDx1t7SA3Abgcw2p4BuZgmdQ | https://api.studio.thegraph.com/query/115545/crossfoot/v0.0.7 (`.../version/latest`) | 2026-09-02 05:04 UTC | live version: at chain head (25,887,725 against 25,887,726, no indexing errors) by 2026-09-02 about 05:50 UTC, about 45 minutes after the deploy from 13,199,212 (the oldest Chainlink phase aggregator); v0.0.5 was archived at this deploy; the consumer secret and fixture point here |
