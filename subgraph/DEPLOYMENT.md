...
| v0.0.5 (`subgraph.events.yaml` with both Midas ABIs on every Midas source, commit b3d9489) | QmPm4RhwubryZFgcrXmhEEAxB3eTkpKCevUjbA9vg3kGgh | https://api.studio.thegraph.com/query/115545/crossfoot/v0.0.5 | 2026-09-02 01:27 UTC | pending; sat at its start block 17,676,541 until about 02:50 UTC, then synced at the event-only rate; the fix was confirmed on the local graph-node (blocks 24,798,500 to 24,800,800: the mGLOBAL feed is created with bound 100000000, one Upgrade, one BoundChange) |
