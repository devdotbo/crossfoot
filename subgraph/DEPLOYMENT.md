...
| v0.0.4 (`subgraph.yaml`, call handlers, 73 sources) | QmY2FcaT6THZn7iN5Wn8Hq54X9GwqewMYKYkBqHVEoUrVa | https://api.studio.thegraph.com/query/115545/crossfoot/v0.0.4 | 2026-09-02 00:26 UTC | syncing at about 6,900 blocks per minute; carries the same defect and will fail at 24,798,563 (about 17 hours after deploy); redeploy from the fixed `subgraph.yaml` when a call-handler version is wanted |
| v0.0.5 (`subgraph.events.yaml` with both Midas ABIs on every Midas source, commit b3d9489) | QmPm4RhwubryZFgcrXmhEEAxB3eTkpKCevUjbA9vg3kGgh | https://api.studio.thegraph.com/query/115545/crossfoot/v0.0.5 (`.../version/latest`) | 2026-09-02 01:27 UTC | pending; started at 17,676,541; the fix was confirmed on the local graph-node (blocks 24,798,500 to 24,800,800: the mGLOBAL feed is created with bound 100000000, one Upgrade, one BoundChange) |
